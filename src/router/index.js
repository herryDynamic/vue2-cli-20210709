...
export default new Router({
  mode: "hash", // 默认为'hash'模式,可更换history
    ...
    children: [
      {
        ...
        component: () => import("@/views/fundData/fundPosition")
      },
      {
        path: "typePosition",
        name: "typePosition",
        ...
        component: () => import("@/views/fundData/typePosition")
      },
      {
        ...
        component: () => import("@/views/fundData/incomePayPosition")
      }
    ]
  },
  {
